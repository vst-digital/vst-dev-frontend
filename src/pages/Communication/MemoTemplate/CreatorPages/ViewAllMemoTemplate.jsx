...
const ViewAllMemo = ({ history }) => {
    ...
    const onAddClick = () => history.push(`/memo_template/new`, { data: { action: 'Add', memoTemplate: new MemoTemplate() } });
    ...
    const editHandler = async (id) => {
        ...
        try {
            ...
            history.push(`/memo_template/edit`, { data: { action: 'Edit', memoTemplate: new MemoTemplate(res.data) } });
        } catch (e) {
    ...
    const viewHandler = async (id) => {
        try {
            ...
            history.push(`/memo_template/view`, { data: { action: 'View', memoTemplate: new MemoTemplate(res.data) } });
        }catch(e){
