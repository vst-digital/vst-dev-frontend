...
import { ArrowDownwardRounded, MoneyRounded, ReportOffRounded } from '@material-ui/icons';
        ...
        <Card className={classes.root}>
            <CardContent>
                ...
                <div className={classes.difference}>
                    <Button variant="outlined" color="primary" size="large" onClick={() => history.push('/reports')}>Reports</Button>
                </div>
            </CardContent>
        </Card>
    );
